...
def get_colours():
    ...
    colours name, associated score and foreground colour for the text
    """
...
class Play:
    ...
    def new_round(self):
        ...
        self.all_high_scores_list.append(highest)
    ...
    def round_results(self, user_choice):
        ...
        """
        print("colour list", self.round_colour_list)
